...
var thounsandToTrillion = ["thousand", "million", "billion", "trillion"];
//declaring string that will be the output
var output = "";

//function that will take in a number and convert said number to a string with the above variables
const sayNumber = (num) => {
